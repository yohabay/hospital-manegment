...
if(isset($_POST['submit'])) {
    ...
    $select = mysqli_query($conn, "SELECT * FROM `patient-recient` WHERE password = '$password' AND email = '$email' AND status='approved'") or die('query failed');
...
<section>
    ...
    <div class="nav">
    <a href="home.php" class="text-info">backHome</a>
    </div>
    </nav>
    </section>
   ...
   <form action="" method="post" enctype="multipart/form-data">
      ...
      <p>don't have an account? <a href="patient-signup.php">regiser now</a></p>
   </form>
