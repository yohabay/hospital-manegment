   ...
   <h1><a href="home.php" class="text-light text-decoration-none"><img src="logo.png" class="logo"></a></h1>
    ...
    <div class="container ">
        ...
        <div class="col doctor-value"> 
           <h6><a href="doctor-record.php">Doctors List</a></h6>
            
        </div>
        <div class="col register-value"> 
        <h6><a href="register-doctor.php">Register Doctor</a></h6>
        </div>
        <div class="col appointment-value">
        <h6><a href="doctors-list-spetalisation.php">Doctor Specialization</a></h6>
        </div>
        </div>
        </div>
    </div>
