...
<div class="right-side">
   ...
   <h1><a href="home.php" class="text-light text-decoration-none"><img src="logo.png" class="logo"></a></h1>
    ...
    <div class=" my-5">
        <div class="col">
        <h2 class="text-center  ">reject the doctor</h2>
  ...
  <?php 
     include 'database.php';
    $sql="SELECT * from `receint-doctor`";
    $result=mysqli_query($conn,$sql);
    if($result){
    while($row=mysqli_fetch_assoc($result)){
      ...
      <td>$department</td>
      <td>
       <button class='btn btn-danger'><a href='doctor-reject.php?deleteid=$id'class='text-light'>reject</a></button>
      <td>
    </tr> 
       ";
