...
<div class="right-side">
  ...
  <?php 
     include 'database.php';
    $sql="SELECT * from `receint-doctor` where status='approved'";
    $result=mysqli_query($conn,$sql);
    if($result){
    while($row=mysqli_fetch_assoc($result)){
      ...
      <th>$address</th>
      <th>$department</th>
      <th> <button class='btn btn-primary '><a href='docteor-update.php?updateid=$id' class='text-light '>Update</a></button>
       <button class='btn btn-danger'><a href='docteor-delete.php?deleteid=$id'class='text-light'>reject</a></button></th>
