...
if(isset($_POST['submit'])){
   ...
   if(mysqli_num_rows($select) > 0){
      ...
      $insert = mysqli_query($conn, "INSERT INTO `appointment_list`(doctor_name, patient_name, descripition) VALUES('$doctor_name', '$patient_name', '$descripition')") or die('query failed');

      if($insert){
         header('location:patient-view-record.php');
      }
      else{
...
<section>
    <nav>
    <h1><a href="home.php" class="text-light text-decoration-none">HM</a></h1>
    <div class="nav ">
