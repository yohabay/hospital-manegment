...
<div class="right-side">
  ...
  <?php 
     include 'database.php';
    $sql="SELECT * from `patient-recient`where status='approved'";
    $result=mysqli_query($conn,$sql);
    if($result){
    while($row=mysqli_fetch_assoc($result)){
      ...
      <td>$doctorname</td>
      <td>$time</td>
      <td> <button class='btn btn-primary '><a href='patient-update.php?updateid=$id' class='text-light '>Update</a></button>
       <button class='btn btn-danger'><a href='patient-delete.php?deleteid=$id'class='text-light'>Treated</a></button>
      <td>
    </tr> 
       ";
